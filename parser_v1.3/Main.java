...
//		(p&r) − p
		...
		String str;
		System.out.print("Please type in the testing string: ");
		str=sc.nextLine();

		Word testString = new Word(str);
		// is in lang?
		System.out.println(parser.isInLanguage(cfg, testString));

		// if true, then print true and print out parser tree, if not, reject it
		if (parser.isInLanguage(cfg, testString)){
			System.out.println(parser.generateParseTree(cfg, testString));
		}else{
			System.out.println("Cannot generate the parser tree!");
		}
